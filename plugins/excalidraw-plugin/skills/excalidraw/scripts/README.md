...
1. **Create library directory**:
   ```bash
   mkdir -p libraries/libraries/aws-architecture-icons
   ```
...
3. **Run the script**:
   ```bash
   python libraries/scripts/split-excalidraw-library.py libraries/libraries/aws-architecture-icons/
   ```
...
```
libraries/libraries/aws-architecture-icons/
